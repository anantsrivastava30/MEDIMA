...
\title{3D - Patch Based Feature Extraction for \Alz Disease Diagnosis via FDG-PET Analysis}
...
% \clearpage ROC comparing all clinical groups
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figures/auc1.png}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figures/auc2.png}
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{figures/auc3.png}
...
%  ALGORITHM USED FOR SCC REMOVED FROM THIS DRAFT UNBALANCED INFORMATION
% \begin{algorithm}
% 	\vspace{1em}
